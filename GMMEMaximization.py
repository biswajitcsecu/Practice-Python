...
def train(num_patches, image,n_samples,w,h):
    ...
    rain=imtrain[:1000]    	
    gmm = mixture.GaussianMixture(n_components=7, covariance_type='full',tol=0.001, reg_covar=1e-06, max_iter=1200, n_init=1, init_params='kmeans', 
